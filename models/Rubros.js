...
Rubros.prototype.cleanUp = function () {
  if (typeof this.data.addRubroNro != "string") {
    this.data.addRubroNro = "";
  }
  if (typeof this.data.addRubroDescri != "string") {
    this.data.addRubroDescri = "";
  }
  if (typeof this.data.addRubroNivel != "string") {
    this.data.addRubroNivel = "";
  }
